...
See type-patterns.md for detailed concepts. Load dev-typescript/SKILL.md for TypeScript-specific implementations. </type_safety>
...
With dev- skills:*
    ...
    dev-typescript: TypeScript implementation patterns
    dev-react: React component patterns
    dev-hono: API framework patterns
    dev-bun: Runtime-specific patterns

Senior developer skill provides the "why" and "when". dev-* skills provide the "how" for specific technologies. </workflow_integration>
ALWAYS: - Read CLAUDE.md and project rules first - Follow existing codebase patterns - Make small, focused changes - Validate external input - Handle errors explicitly - Test critical paths - Document non-obvious decisions - Ask when uncertain on high-stakes issues
...
Development Skills (load dev-*/SKILL.md for implementation patterns):
    ...
    dev-typescript/SKILL.md — TypeScript patterns, Zod, modern features
    dev-react/SKILL.md — React 18-19 patterns, hooks typing
    dev-hono/SKILL.md — Hono API framework patterns
    dev-bun/SKILL.md — Bun runtime APIs, SQLite, testing
